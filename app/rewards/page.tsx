...
import { Reward, Partner } from "../types/rewards";
...
export default function RewardsPage() {
  ...
  // Get partners that have locations in user's city
    ...
    >
      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        <header className="flex items-center justify-between gap-3 p-4 md:p-6 lg:p-8 flex-shrink-0">
          ...
          {profile && <UserStatusHeader {...{ ecoPoints: profile.ecoPoints, streak: profile.streak, level: profile.level }} />}
        </header>
