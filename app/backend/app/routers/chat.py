...
async def save_user_message(user_id: int, message_text: str, db: Session = Depends(get_db)):
...
async def save_assistant_message(user_id: int, message_text: str, db: Session = Depends(get_db)):
