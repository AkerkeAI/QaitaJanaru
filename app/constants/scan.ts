...
export const MOCK_WASTE_TYPES: WasteDetectionResult[] = [
  ...
  },
  {
    ...
    preparation_steps: ["Empty bottle", "Rinse lightly", "Remove cap if required"],
    recyclable: true,
  },
  {
    waste_type: "Paper",
    ...
    preparation_steps: ["Keep paper dry", "Remove plastic windows", "Flatten sheets"],
    recyclable: true,
  },
  {
  ...
  },
  {
    ...
    preparation_steps: ["Remove batteries if detachable", "Keep device intact", "Use authorized e-waste point"],
    recyclable: true,
  },
  {
    ...
    preparation_steps: ["Remove packaging", "Compost food scraps only", "No plastic bags"],
    recyclable: false,
  }
];

// Placeholder/mock recycling centers removed — use real data from /data/recyclingPoints.ts
